...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # temporary arg from the given index.
...
if [ ! -f "$APP_HOME/gradle/wrapper/gradle-wrapper.jar" ]; then
    ...
    wget -q -O "$APP_HOME/gradle/wrapper/gradle-wrapper.jar" \
        "https://raw.githubusercontent.com/gradle/gradle/v8.2.0/gradle/wrapper/gradle-wrapper.jar" || \
    die "Could not download gradle-wrapper.jar. Please download it manually."
fi

# Collect all arguments for the java command;
#   * $DEFAULT_JVM_OPTS, $JAVA_OPTS, and $GRADLE_OPTS can contain fragments of
#     temporary args, e.g. "-Dprop=value", due to Java's interpretation of
#     property assignment syntax
#   * DEFAULT_JVM_OPTS://     default options for the JVM
#   * JAVA_OPTS://            general JVM options
#   * GRADLE_OPTS://          options specific to Gradle
